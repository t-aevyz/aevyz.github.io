...
When committing it is advisable to have a ***sensible*** comment. This helps people, including you, understand what each commit does, which is especially useful for when you need to revert a mistake.
